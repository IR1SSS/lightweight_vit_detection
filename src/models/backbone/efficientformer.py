"""
EfficientFormerV2 backbone implementation.
Vision Transformers for MobileNet Size and Speed (ICCV 2023).

This module provides EfficientFormerV2 models (S0, S1, S2, L)
for use as backbone in object detection.
"""
import os
import copy
import torch
